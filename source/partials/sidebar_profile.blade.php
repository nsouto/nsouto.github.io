        ...
        <div class="mx-4 mt-12 text-center user-info lg:mx-6">
            <a href="index.html"
               class="w-36 h-36 mb-2.5 block mx-auto border-6 border-platinum dark:border-[#2f2f2f] overflow-hidden rounded-full *:w-full *:h-full *:rounded-full">
                <img
                        src="assets/build/img/user-sidebar-thumb.webp"
                        class="hidden dark:block "
                        alt="Nuno Souto"> {{--Image for Dark Version --}}
                <img
                        src="assets/build/img/user-sidebar-thumb-light.webp"
                        class="dark:hidden"
                        alt="Nuno Souto"> {{--Image for Light Version --}}
            </a>
            <h6 class="mb-1 text-lg font-semibold text-black dark:text-white name">Nuno Souto</h6>
...
{{--            </div>--}}
            ...
            <div class="mt-6">
                <a href="https://nsouto.s3.amazonaws.com/shared/Nuno-Souto-Resume-2k24.pdf" download target="_blank"

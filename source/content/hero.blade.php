...
<div data-scroll-index="0" id="home">
    ...
    <div class="hero-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
        ...
        <div class="items-center gap-6 hero-content md:flex xl:gap-10">
            <div class="text-content pt-7 lg:pt-8 max-lg:max-w-[30rem]">
                <h1 class="text-[32px] lg:text-5xl xl:text-4xl 2xl:text-5xl font-semibold text-black dark:text-white leading-1.27 lg:leading-1.27 xl:leading-1.27 2xl:leading-1.27 mb-4 lg:mb-5">
                    I Build <br>
                    <span class="text-theme">Scalable Solutions</span>
                </h1>
                <p>
                    With a <span class="font-medium text-black dark:text-white/90">passion for technology</span>, I create efficient systems that solve real-world problems. From web apps to infrastructure, I bring creativity and practical problem-solving to every challenge.
                </p>
            ...
            <div class="hero-image flex-[0_0_20.3rem] max-md:hidden">
                <img
                        src="assets/build/img/hero-img-1.webp"
                        class="dark:hidden"
                        alt="Hero Image - Light Mode">
                <img
                        src="assets/build/img/hero-img-2.webp"
        ...
        <div class="mb-2 mt-14 xl:mb-0 xl:mt-20">
            ...
            {{--                                                    <img src="assets/build/img/partners/logo1.svg" alt="Partner Name">--}}
            {{--                                                </a>--}}
            {{--                                            </div>--}}
            {{--                                            <div class="swiper-slide">--}}
            {{--                                                <a href="#"--}}
            {{--                                                    class="transition duration-200 flex-center">--}}
            {{--                                                    <img src="assets/build/img/partners/logo2.svg" alt="Partner Name">--}}
            {{--                                                </a>--}}
            {{--                                            </div>--}}
            {{--                                            <div class="swiper-slide">--}}
            {{--                                                <a href="#"--}}
            {{--                                                    class="transition duration-200 flex-center">--}}
            {{--                                                    <img src="assets/build/img/partners/logo3.svg" alt="Partner Name">--}}
            {{--                                                </a>--}}
            {{--                                            </div>--}}
            {{--                                            <div class="swiper-slide">--}}
            {{--                                                <a href="#"--}}
            {{--                                                    class="transition duration-200 flex-center">--}}
            {{--                                                    <img src="assets/build/img/partners/logo4.svg" alt="Partner Name">--}}
            {{--                                                </a>--}}
            {{--                                            </div>--}}
            {{--                                            <div class="swiper-slide">--}}
            {{--                                                <a href="#"--}}

...
{{--            </div>--}}
            ...
            <ul class="grid mt-4 mb-10 text-sm lg:mt-6 md:grid-cols-2 gap-x-8 gap-y-3 *:flex *:items-center">
                <li>
                    ...
                    <span class="text-black dark:text-white">+1 (416) 409-8910</span>
                </li>
                <li>
                    <span class="flex-[0_0_6rem]">Email</span>
                    <span class="flex-[0_0_2rem]">:</span>
                    <span class="text-black dark:text-white">nsouto@lostlink.net</span>
                </li>
                {{--                                <li>--}}
                ...
                <li>
                    ...
                    <span class="flex-[0_0_2rem]">:</span>
                    <span class="text-black dark:text-white">github.com/nsouto</span>
                </li>
                <li>
                    <span class="flex-[0_0_6rem]">Language</span>
                    <span class="flex-[0_0_2rem]">:</span>
                    <span class="text-black dark:text-white">English, Portuguese, Cape Verdean Creole, Spanish, French, Italian</span>
                </li>
            </ul>

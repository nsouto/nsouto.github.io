    ...
    <div class="service-section relative px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
        ...
        <div class="mb-8 mt-7 md:my-10 section-title">
            ...
            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                I specialize in software development for the web, with a primary focus on PHP and the Laravel ecosystem. My expertise
                also extends into DevOps, where I have hands-on experience with tools like Ansible, AWS, and other cloud platforms.
                I’m proficient in using Terraform for infrastructure as code and building serverless architectures. I have a strong
                background in creating scalable systems optimized for performance and cost, especially in handling high-traffic
                environments. Additionally, I have worked on email marketing campaigns and developed text messaging applications,
                ensuring reliable and efficient communication solutions.
            </p>
        </div>
...
{{--                            <img src="assets/build/img/skill/figma.svg" class="dark:grayscale" alt="Figma">--}}
{{--                        </div>--}}
...
{{--                    <div class="swiper-slide">--}}
{{--                        <div class="text-center icon">--}}
{{--                            <img src="assets/build/img/skill/webflow.svg" class="dark:grayscale" alt="webflow">--}}
{{--                        </div>--}}
{{--                        <div class="progressCircle">--}}
{{--                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"--}}
...
{{--                    <div class="swiper-slide">--}}
{{--                        <div class="text-center icon">--}}
{{--                            <img src="assets/build/img/skill/tailwind.svg" class="dark:grayscale" alt="TailwindCSS">--}}
{{--                        </div>--}}
{{--                        <div class="progressCircle">--}}
{{--                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"--}}
{{--                                 data-percent="90" data-circlefill="#00BC91" data-circleempty="#777777">--}}
...
{{--                    <div class="swiper-slide">--}}
{{--                        <div class="text-center icon">--}}
{{--                            <img src="assets/build/img/skill/html.svg" class="dark:grayscale" alt="HTML5">--}}
{{--                        </div>--}}
{{--                        <div class="progressCircle">--}}
{{--                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"--}}
...
{{--                    <div class="swiper-slide">--}}
{{--                        <div class="text-center icon">--}}
{{--                            <img src="assets/build/img/skill/css.svg" class="dark:grayscale" alt="CSS3">--}}
{{--                        </div>--}}
{{--                        <div class="progressCircle">--}}
{{--                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"--}}
{{--                                 data-percent="95" data-circlefill="#00BC91" data-circleempty="#777777">--}}
...
{{--                    <div class="swiper-slide">--}}
{{--                        <div class="text-center icon">--}}
{{--                            <img src="assets/build/img/skill/js.svg" class="dark:grayscale" alt="JavaScript">--}}
{{--                        </div>--}}
{{--                        <div class="progressCircle">--}}
{{--                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"--}}
...
{{--                    <div class="swiper-slide">--}}
{{--                        <div class="text-center icon">--}}
{{--                            <img src="assets/build/img/skill/jquery.svg" class="dark:grayscale" alt="jQuery">--}}
{{--                        </div>--}}
{{--                        <div class="progressCircle">--}}
{{--                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"--}}
